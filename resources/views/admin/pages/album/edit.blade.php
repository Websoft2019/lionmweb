                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <input style="border: 1px solid #000;" type="text" class="form-control p-2" id="name" value="{{ $album->name }}"
                                ...
                                <div class="mt-3">
                                    <input type="text" style="border: 1px solid #000;" class="form-control p-2" id="slug" value="{{ $album->slug }}"
                            ...
                            <div class="card-body">
                                <div class="form-check form-switch">
                                    <input class="form-check-input me-4" type="checkbox" role="switch" name="status"
                                        id="flexSwitchCheckChecked" @checked($album->status == 'active')>
