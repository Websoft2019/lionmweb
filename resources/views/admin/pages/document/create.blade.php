                    ...
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="row">
                            ...
                            <div class="col-6" style="text-align:right;">
                                <a class="btn btn-primary" href="{{ route('admin.document.index') }}">Manage
                                    Document</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                                                    <div
                                                        class="input-group input-group-outline @if (old('type') != '') focused is-focused @endif">
                                                        {{-- <label class="form-label">Document Name *</label> --}}
                                                        <select class="form-select" name="type" id="type">
                                                            <option value="directory">Directory</option>
                                                            <option value="padauabiyan">Padhou Abhiyan</option>
                                                            <option value="bloodbank">Blood Donation</option>
