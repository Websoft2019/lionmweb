                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('club.postAddNewMember') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="club_membership_id">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="office_number">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Spouse/Companion Name</label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Club Join Date</label>
                                    <input type="date" class="form-control" name="club_join_date">
                                </div>
                            </div>
