        ...
        <div class="profilebox">
            <div class="row">
                <div class="col-md-2" style="text-align:center;">
                    ...
                    @endif
                    <a href=""data-bs-toggle="modal" data-bs-target="#ChangeLogo" style="color:#ccc; text-decoration: underline;">modify logo</a>
                </div>
                <div class="col-md-10">
                    <form action="{{ route('club.postModifyProfile') }}" method="POST">
                        @csrf()
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-success" role="alert">
                                    <h4 class="alert-heading">Well done!</h4>
                                    <p>Club not allow to change <strong>Club Name, Club ID, Login Mobile Number</strong> for security propose. If these information incorrect you need to request District Secretary.</p>
                                    <hr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="club" value="{{ $club->name }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Club ID</label>
                                    <input type="text" class="form-control" value="{{ $club->club_membership_id }}" disabled>
                                    <input type="hidden" name="club_membership_id" value="{{ $club->club_membership_id }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Charter Date <small style="color:red;">*</small></label>
                                    <input type="date" class="form-control" name="charter_date" value="{{ date('Y-m-d', strtotime($club->charter_date)) }}" required>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Mother Club</label>
                                    <input type="text" class="form-control" name="mother_club" value="{{ $club->mother_club }}" required disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Club Address <small style="color:red;">*</small></label>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="province" id="OprovinceSelection" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="district" id="OdestrictsSelection" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Municipality/Metropolitian/VDC <small style="color:red;">*</small></label>
                                    <select class="form-control" name="VDC_Metro" id="OmunicipalitySelection" required>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Word No. <small style="color:red;">*</small></label>
                                    <input class="form-control" type="number" name="wordno" value="{{ $club->wordno }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="club_email" value="{{ $club->email }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Club Website</label>
                                    <input type="text" class="form-control" name="club_website" value="{{ $club->website }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Club Regular Meeting Location <small style="color:red;">*</small></label>
                                    <input type="text" class="form-control" name="regular_meeting_location" value="{{ $club->regular_meeting_location }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Club Contact Person <small style="color:red;">*</small></label>
                                    <input type="text" class="form-control" name="contact_person" value="{{ $club->contact_person }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Contact Person Designation <small style="color:red;">*</small></label>
                                    <select class="form-control" name="contact_person_designation_id" required>
                                        @foreach($officers as $officer)
                                            <option value="{{ $officer->id }}" <?php if($club->contact_person_designation_id == $officer->id){ echo 'selected'; } ?>>{{ $officer->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Contact Number <small style="color:red;">*</small></label>
                                    <input type="text" class="form-control" name="contact_number" value="{{ $club->contact_number}}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="introduction">{{ $club->introduction }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content modal-lg">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Change Club Logo</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="{{ route('club.postUploadLogo') }}" method="POST" enctype="multipart/form-data">
            @csrf()
