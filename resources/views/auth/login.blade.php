              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    <h4 class="mt-1 mb-5 pb-1">CLUB LOGIN</h4>
        ...
        <x-auth-validation-errors class="mb-4" :errors="$errors" />
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form2Example11">Club ID</label>
                      <input type="text" id="email" name="email" value="{{ old('email') }}" class="form-control"
                        placeholder="Your Club ID" required autofocus/>
              ...
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                <div class="text-white px-3 py-4 col-lg-12" style="text-align:center;">
                    <img src="{{ asset('site/assets/images/logo.png') }}" alt="" width="200">
