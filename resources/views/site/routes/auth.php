...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/registration/payment/{hash}', 'App\Http\Controllers\HomeController@getPayment')->name('club.getPayment');
    Route::post('/payment/{hash}', 'App\Http\Controllers\HomeController@postDoPayment')->name('club.postDoPayment');
    ...
    Route::post('payment_status/fonepay_payment_success', 'App\Http\Controllers\HomeController@getFonepayResult');
